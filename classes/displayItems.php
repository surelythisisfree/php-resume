<?php
	class displayItems {
		...
		static function displaySection($slideNum, $slides, $sectionDetails, $sectionName, $resume) {	
		
			//Open the slide div if applicable
			displayItems::displaySlideStart($sectionDetails[$sectionName]['slide']);
			...
			foreach($slides as $content) {
				echo '<div class="'.$sectionDetails[$sectionName]['class'].'">';
				echo $content['content'];
				echo '</div>';
			}
			
			//Close the slide div if applicable
			displayItems::displaySlideEnd($sectionDetails[$sectionName]['slide']);
